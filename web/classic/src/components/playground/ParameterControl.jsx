  ...
  return (
    <>
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Thermometer size={16} style={{ color: 'var(--hp-sub)' }} />
        ...
        <Typography.Text className='text-xs mb-2' style={{ color: 'var(--hp-sub)' }}>
          {t('控制输出的随机性和创造性')}
        </Typography.Text>
        <Slider
          step={0.1}
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Target size={16} style={{ color: 'var(--hp-sub)' }} />
            <Typography.Text strong className='text-sm'>
              Top P
            </Typography.Text>
            <Tag size='small' shape='circle'>
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Repeat size={16} style={{ color: 'var(--hp-sub)' }} />
            <Typography.Text strong className='text-sm'>
              Frequency Penalty
            </Typography.Text>
            <Tag size='small' shape='circle'>
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Ban size={16} style={{ color: 'var(--hp-sub)' }} />
            <Typography.Text strong className='text-sm'>
              Presence Penalty
            </Typography.Text>
            <Tag size='small' shape='circle'>
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Hash size={16} style={{ color: 'var(--hp-sub)' }} />
            <Typography.Text strong className='text-sm'>
              Max Tokens
            </Typography.Text>
          </div>
      ...
      >
        <div className='flex items-center justify-between mb-2'>
          <div className='flex items-center gap-2'>
            <Shuffle size={16} style={{ color: 'var(--hp-sub)' }} />
            <Typography.Text strong className='text-sm'>
              Seed
            </Typography.Text>
            <Typography.Text className='text-xs' style={{ color: 'var(--hp-muted)' }}>
              ({t('可选，用于复现结果')})
            </Typography.Text>
          </div>
          <Button
