...
const TopUp = () => {
  ...
  const getUserQuota = async () => {
    try {
      ...
      console.error('Failed to get user quota:', err);
    }
  };
            ...
            payMethods = payMethods.map((method) => {
              ...
              if (!method.color) {
                if (method.type === 'alipay') {
                  method.color = 'rgba(var(--semi-orange-5), 1)';
  ...
  const getAffLink = async () => {
    try {
      ...
      console.error('Failed to get aff link:', err);
    }
  };
  ...
  return (
    <div
      className='w-full max-w-7xl mx-auto relative min-h-screen lg:min-h-0 px-4 sm:px-6 lg:px-8 pb-16'
